  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        hero: {
          from: "hsl(var(--hero-bg-from))",
          to: "hsl(var(--hero-bg-to))",
      ...
      keyframes: {
        ...
        "slide-in-right": {
          "0%": { opacity: "0", transform: "translateX(100px) perspective(1000px) rotateY(-15deg)" },
          "100%": { opacity: "1", transform: "translateX(0) perspective(1000px) rotateY(0)" },
        },
        "float": {
      ...
      animation: {
        ...
        "grain": "grain 4s ease-in-out infinite",
        "underline-grow": "underline-grow 0.8s cubic-bezier(0.4, 0, 0.2, 1) forwards",
      },
    },
  },
